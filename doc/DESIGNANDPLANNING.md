...
![back-end architecture](/doc/img/03_backendarc.jpg)</br> 
...
 
### Model Design
![entity relation](/doc/img/04_ermodel.jpg)</br> 
...
![ER schema](/doc/img/05_erschema.jpg)</br> 
...
 
2) Book service
![book service](/doc/img/11_bookservice.jpg)</br>
 
3) Article service
![article service](/doc/img/12_articleservice.jpg)</br> 

 
### Back-end API
The application will access the database by making http requests to the appropriate url in the following table.
![back-end API](/doc/img/13_backapi.jpg)</br> 
